...
import Logo from "../../static/images/logo.png1.png";
      ...
      <div className={classes.background}>
        ...
        >
          <div className={classes.content}>
            ...
            >
              We are setting up things for you, hold tight, it shouldn't take
              long. If you have just registered with Stari things will be ready
              within few minutes, if you have been using Stari for long time and
              has many transactions the process might take longer but the wait
              will be worth it.
            </p>
          </div>
        </div>
